...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime5.jsx)(React5.Fragment, {
    children: React5.cloneElement(children2, childrenProps)
  });
}
...
var Portal = React24.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React24.isValidElement(children2) ? children2.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
var _excluded12 = ["autoFocus", "children", "defaultValue", "defaultListboxOpen", "disabled", "getSerializedValue", "listboxId", "listboxOpen", "multiple", "name", "onChange", "onListboxOpenChange", "getOptionAsString", "renderValue", "slotProps", "slots", "value"];
...
var FormControlContext2 = React59.createContext(void 0);
if (true) {
...
function useFormControl() {
  return React60.useContext(FormControlContext_default2);
}
...
function Ripple(props) {
  ...
  const [leaving, setLeaving] = React67.useState(false);
...
var _excluded24 = ["center", "classes", "className"];
var _ = (t) => t;
var _t;
var _t2;
var _t3;
...
var TouchRipple = React68.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const [ripples, setRipples] = React68.useState([]);
  const nextKey = React68.useRef(0);
  const rippleCallback = React68.useRef(null);
  React68.useEffect(() => {
  ...
  const ignoringMouseDown = React68.useRef(false);
  const startTimer = React68.useRef(null);
  const startTimerCommit = React68.useRef(null);
  const container = React68.useRef(null);
  React68.useEffect(() => {
    return () => {
      clearTimeout(startTimer.current);
    };
  }, []);
  const startCommit = React68.useCallback((params) => {
    const {
      pulsate: pulsate2,
      rippleX,
      rippleY,
    ...
    setRipples((oldRipples) => [...oldRipples, (0, import_jsx_runtime43.jsx)(TouchRippleRipple, {
      classes: {
  ...
  const start2 = React68.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
  ...
  const pulsate = React68.useCallback(() => {
    start2({}, {
      pulsate: true
    });
  }, [start2]);
  const stop = React68.useCallback((event, cb) => {
    clearTimeout(startTimer.current);
  ...
  return (0, import_jsx_runtime43.jsx)(TouchRippleRoot, _extends({
    className: clsx_m_default(touchRippleClasses_default.root, classes.root, className),
    ref: container
  }, other, {
    children: (0, import_jsx_runtime43.jsx)(TransitionGroup_default, {
      component: null,
      exit: true,
      children: ripples
    })
...
var ButtonBase = React69.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiButtonBase"
  });
  ...
  const rippleRef = React69.useRef(null);
  ...
  const keydownRef = React69.useRef(false);
  ...
  return (0, import_jsx_runtime45.jsxs)(ButtonBaseRoot, _extends({
    as: ComponentProp,
    ...
    children: [children2, enableTouchRipple ? (
      ...
      (0, import_jsx_runtime44.jsx)(TouchRipple_default, _extends({
        ref: handleRippleRef,
        center: centerRipple
      }, TouchRippleProps))
    ) : null]
...
var SwitchBase = React70.forwardRef(function SwitchBase2(props, ref) {
  const {
    autoFocus,
    checked: checkedProp,
    checkedIcon,
...
var switchClasses_default2 = switchClasses2;
...
var SwitchSwitchBase = styled_default(SwitchBase_default, {
  ...
  overridesResolver: (props, styles2) => {
    ...
    return [styles2.switchBase, {
      [`& .${switchClasses_default2.input}`]: styles2.input
...
var Switch3 = React71.forwardRef(function Switch4(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSwitch"
  });
  ...
  const icon = (0, import_jsx_runtime48.jsx)(SwitchThumb, {
    className: classes.thumb,
    ownerState
  });
  return (0, import_jsx_runtime49.jsxs)(SwitchRoot, {
    className: clsx_m_default(classes.root, className),
    sx,
    ownerState,
    children: [(0, import_jsx_runtime48.jsx)(SwitchSwitchBase, _extends({
      type: "checkbox",
      icon,
      checkedIcon: icon,
      ref,
    ...
    })), (0, import_jsx_runtime48.jsx)(SwitchTrack, {
      className: classes.track,
      ownerState
    })]
  });
...
export {
  ...
  ButtonBase_default,
  FormControlContext_default2 as FormControlContext_default,
  useFormControl,
  SwitchBase_default,
  getSwitchUtilityClass2 as getSwitchUtilityClass,
  switchClasses_default2 as switchClasses_default,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SRCJ4WEH.js.map
